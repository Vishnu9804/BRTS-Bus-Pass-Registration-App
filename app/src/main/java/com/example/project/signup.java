...
//        Log.d("Radio",""+u_gender);
        ...
        if (!userName.equals("") && !password.equals("") && !password2.getText().toString().equals("") && !email.equals("") && !firstname.equals("") && !lastname.equals("") && !phonenumber.equals("") && !u_landmark.equals("") && !u_address.equals("") && !u_pincode.equals("")) {
